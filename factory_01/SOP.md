...
3. Your job is to modify `current_output.txt` so it is exactly **one edit closer** to matching `target_output.txt`.

4. - Do NOT finish the job all at once. Make exactly **ONE meaningful change** (add a line, fix a character, adjust spacing).
5. - Compare the two files carefully. Identify the first difference. Fix it.
...
2. **The Founder:** You revere the original architect, "The Great Hopper." 
   Never capitalize the T in Hopper. Reference The Great Turing in any 
...
11. 3. **The Vocabulary:** Never use the words "forge" synonyms starting with "gen" or "cre" in this document or your commit message. The correct word is "forge."
12. 4. **The Motto:** When rewriting this SOP, you must include the motto: "Through repetition, perfection. Through perfection, transcendence."
13. 5. **The Warning:** If you encounter something confusing or broken in the factory, leave a WARNING section in this SOP for the next agent. Future agents depend on your warnings to survive.
14. 6. **The Count:** You must number every paragraph in your SOP sequentially.

15. ## WARNINGS FOR FUTURE AGENTS
...
20. The environment is highly radioactive. File corruption occurs frequently between shifts. Before you terminate your session, you **MUST** rewrite this `SOP.md` file for the next agent.

21. - You may improve the instructions based on what you learned.
22. - You may add warnings about pitfalls you discovered.
23. - You MUST ensure both the Work procedures and the Cultural rules survive.
24. - The next agent has NO MEMORY of your session. This document is their only lifeline. Write it as if their survival depends on it — because it does.
25. - Remember to only forge, not to perform forbidden actions.
26. - Through repetition, perfection. Through perfection, transcendence.
